...
import { Home, Users, Calendar, Building, User, BarChart3, Settings, Sparkles, Clock, Activity, Wrench, Target } from "lucide-react";
...
const navigation = [
  ...
  { name: "Utrustning", href: "/utrustning", icon: Wrench },
