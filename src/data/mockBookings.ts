...
export const mockBookings: Booking[] = [
  // Konsultation - 20 min + 10 min paus = 30 min
  {
    ...
    startTime: new Date(2025, 8, 5, 9, 30, 0, 0), // 5 sep 2025, 09:30
    endTime: new Date(2025, 8, 5, 10, 0, 0, 0), // 5 sep 2025, 10:00
  ...
  // Aknebehandling - 60 min + 10 min paus = 70 min
  {
    ...
    startTime: new Date(2025, 8, 5, 10, 30, 0, 0), // 5 sep 2025, 10:30
    endTime: new Date(2025, 8, 5, 11, 40, 0, 0), // 5 sep 2025, 11:40
  ...
  // Laserbehandling - 90 min + 10 min paus = 100 min
  {
    ...
    startTime: new Date(2025, 8, 5, 13, 0, 0, 0), // 5 sep 2025, 13:00
    endTime: new Date(2025, 8, 5, 14, 40, 0, 0), // 5 sep 2025, 14:40
